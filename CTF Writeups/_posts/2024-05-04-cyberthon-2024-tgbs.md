...
![Sabacc game page](/assets/img/tgbs/sabacc.png)
...
I will be using [edgeshark](https://github.com/siemens/edgeshark) to capture network traffic from within the docker compose environment, which will allow us to view the transfer of HTTP packets using Wireshark. This is not a necessary step, but it's useful for a writeup/tutorial such as this one.
...
![Reveal request](/assets/img/tgbs/reveal.png)
...
![Stream capture](/assets/img/tgbs/stream.png)
...
![Forced draw](/assets/img/tgbs/forced.png)
