...
_'Twas the night before Midterms, when all through the house_ <br>
_Not a creature was stirring, not even a mouse;_ <br>
_The challenges were solved by the players with care_ <br>
_That they won't throw their midterms, and pass by a hair;_ <br><br>
...
TimeKORP - Trivial command injection in format parameter <br>
...
We're given a golang application with file upload using gRPC. Flag is in the root directory. Both the application and the gRPC Ricky server are exposed. Air is used to live-reload the application. Application is run with 
